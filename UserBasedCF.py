...
# @Author  : Aries
# @Site    : http://blog.csdn.net/yourijing/article/details/50098181
# @File    : UserBasedCF.py
# @Software: PyCharm
...
def testRecommend():
    ubcf = UserBasedCF('D:/SourceCode/Python/DataSet/ml-100k/ml-100k/u.data')
    ubcf.readData()
...
def testUserBasedCF():
    cf = UserBasedCF('D:/SourceCode/Python/DataSet/ml-100k/ml-100k/u.data')
