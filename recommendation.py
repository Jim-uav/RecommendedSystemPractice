...
# 最简单的推荐系统实践，网址链接：http://blog.csdn.net/bitcarmanlee/article/details/52684767
...
def read_file():
    ...
    df = pd.read_csv("D:/SourceCode/Python/DataSet/ml-100k/ml-100k/u.data", sep='\t', names=header)
